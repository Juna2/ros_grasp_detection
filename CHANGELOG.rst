^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package ros_grasp_detection
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* fixed permissions of installed ros_grasp_detection files
* remove old Makefiles and bump to 0.2.13
* removed catkin_export_python() from ros_grasp_detection
...
* catkin tweaks
* catkin tweaks
* initial add of ros_grasp_detection
* url fixes
* now uses myargv
