...
TRAIN_FILE = '/home/juna/Documents/robot-grasp-detection/image/custom_dataset/train-cgd'  # '/root/dataset/cornell_grasping_dataset/train-cgd'
VALIDATE_FILE = '/home/juna/Documents/robot-grasp-detection/image/custom_dataset/validation-cgd'  # '/root/dataset/cornell_grasping_dataset/validation-cgd'
    ...
    try:
        ...
        while not coord.should_stop():
            ...
            if FLAGS.train_or_validation == 'train':
                ...
                bbox_value = [(bbox_value[0],bbox_value[1]),(bbox_value[2],bbox_value[3]),(bbox_value[4],bbox_value[5]),(bbox_value[6],bbox_value[7])] 
...
'''./grasp_det.py --model_path /home/juna/Documents/robot-grasp-detection/models/grasp/m4/m4.ckpt --train_or_validation validation'''
'''--num_epochs 5'''