...
'''
'''
1. custom_dataset폴더를 만들고 그 안에 01, 02, 03, ..., 10 폴더를 만든다.
2. 그 폴더들 안에 각각 01은 pcd0101r.png ~ pcd0199r.png 
'''
...
dataset = '/home/juna/Documents/robot-grasp-detection/image/custom_dataset' # '/root/dataset/cornell_grasping_dataset''
